<%-- 
    Document   : viewIngredients
    Created on : Jun 9, 2023, 3:00:47 PM
    Author     : Train
--%>
        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%= ingred.getStock() + " (" + ingred.getUnit().name() + ")"%></td>
                                <td><%= ingred.getMinStockOnHand()%></td>
                    ...
                    <a href="add-ingredient.jsp"><button>Add New Ingredient</button></a>
                </div>
            </div>  
        </div>
