...
<!--                <div class="container-fluid pt-4 px-4">
                ...
                <div id="popup" class="popup">
                    <div class="popup-content">
                        ...
                        <form action="service" method="POST">
                            <centre>
                                <input type ="hidden" id = "pro" name="process"value ="update-category">
                                <input type ="hidden" id = "pro" name="service"value ="admin">
                            </centre>

                            
                            <input type="hidden" id="catId" name="id" required readonly>

                            <input type="hidden" id="catName" name="name" required readonly>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button onclick="openPopup('<%= cat.getCategoryId()%>', '<%= cat.getName()%>', '<%= cat.getDescription()%>')">Edit</button>
                                <% if (cat.isIsActive()) {%>
                                <a href="service?service=admin&process=deactivate-category&categoryId=<%= cat.getCategoryId()%>">
                                    <button>Deactivate</button>
                                </a>
                                <% } else {%>
                                <a href="service?service=admin&process=activate-category&categoryId=<%= cat.getCategoryId()%>">
                ...
                <br>
                <button style="margin-left: 400px" onclick="openPopup1()" >Add New Category</button>

                <script>
                    function openPopup(categoryId, categoryName, categoryDescription) {
                        var popup = document.getElementById("popup");
                        popup.classList.add("active");

                        document.getElementById("catName").value = categoryName;
                        document.getElementById("desc").value = categoryDescription;
