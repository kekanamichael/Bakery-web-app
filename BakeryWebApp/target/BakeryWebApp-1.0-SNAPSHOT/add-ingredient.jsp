            ...
            <div class="form_container">
                ...
                <div class="form test_form">
                    <form action="service">
                        ...
                        <div class="input_box">
                            <input type="text"  name="ingred-name" placeholder="Enter the ingredient name" required />
                        </div>
                        ...
                        <div class="input_box">
                            <input type="number"  name="min-stock" placeholder="Minimum Stock" required />         
                        </div>

                        <div class="input_box">
                            <select id="category" name="unit">
                                <% int cnt=0; for (Unit unit : Unit.values()) {%>
